...
class Front:
    def __init__(self,window):
        #===================Font===================
        self.font1=("roboto ",50,"bold")
        self.font2=("arial",24,"underline")
        self.font3=("bell mt",105,"bold")
        self.font4=("arial",18,"bold")
        #================Top Frame=========
        self.top=Frame(window,width=1366,height=120,bd=10,bg="#fcfcb1",relief=RAISED)
        self.top.propagate(0)
        self.top.place(x=0,y=0)
        #===================Main label=============
        self.l1=Label(self.top,text="WELCOME TO GUPTA'S GRILL",font=self.font1,bg="#fcfcb1",bd=8,fg="#150675",justify=CENTER)
        self.l1.place(x=180,y=0)
        #=============Right Canvas==============
        self.right=Canvas(window,width=1366,height=520,bd=5,bg="#000000",relief=RAISED)
        self.image=ImageTk.PhotoImage(Image.open("4.jpg"))
        id=self.right.create_image(680,250,image=self.image)
        self.right.place(x=0,y=220)
        #==================left  Frame============
        self.left=Frame(window,width=1366,height=100,bd=5,bg="#000000",relief=RAISED)
        self.left.propagate(0)
        self.left.place(x=0,y=120)
        #=====================button=============
        self.button1=Button(self.left,text="BILL COUNTER",width=15,height=3,bd=8,bg="#a3ffff",
                            fg="#000000",command=self.call)
        self.button1.place(x=750,y=10)
        self.button2=Button(self.left,text="CALCULATOR",width=15,height=3,bd=8,bg="#72fcfc",
                            fg="#000000",command=self.cal)
        self.button2.place(x=900,y=10)
        self.button3=Button(self.left,text="Exit",width=15,height=3,bd=8,bg="#26ffff",
                            fg="#000000",command=self.exit)
        self.button3.place(x=1200,y=10)
        self.button4=Button(self.left,text="ABOUT US",width=15,height=3,bd=8,
                            bg="#4fffff",fg="#000000",command=self.aboutus)
        self.button4.place(x=1050,y=10)
        self.button5=Button(self.left,text="MENU",width=15,height=3,bd=8,bg="#a8ffff",
                            fg="#000000",command=self.rate)
    ...
    def call(self):
        ...
        root=Tk()
        obj1=Restra(root)
        root.title("GUPTA'S GRILL")
        root.geometry("1366x768")
        root.configure(background="#fcfcb1")
        root.mainloop()
    def sum(self):
        root=Tk()
        obj1=Bill(root)
...
class Restra(Front):
    def __init__(self,root):
        ...
        self.font4=("arial",18,"bold")
        #============================Frame=========================
        self.top=Frame(root,width=1366,height=120,bd=5,bg="#fcfcb1",relief=RAISED)
        self.top.propagate(0)
        self.top.place(x=0,y=0)
        #===================Main label=============
        self.l1=Label(self.top,text="GUPTA'S GRILL",font=self.font1,
                        bg="#fcfcb1",bd=8,fg="#000000",justify=CENTER)
        self.l1.place(x=400,y=0)
        #====================Menu=================
        ...
        self.l5=Label(self.menu,text="MAIN COURSE=",font=("bell MT",18,"bold"),
                      bg="#4F6367",fg="#EEF5DB")
        self.l5.place(x=40,y=50)
        self.l6=Label(self.menu,text="SNACKS=",font=("bell MT",18,"bold"),
                      bg="#4F6367",fg="#EEF5DB")
        ...
        self.method2={"PIZZA","BURGER","FENCH FRIES","CHILLI POTATO","MOMOS"}
        self.ddvar2.set("PIZZA")
        ...
        #======================Button=================
        #=============================================
        self.add1=Button(self.menu,text="ADD",width=5,height=1,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.vgadd)
        self.add1.place(x=650,y=50)
        self.add2=Button(self.menu,text="ADD",width=5,height=1,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.nvgadd)
        self.add2.place(x=650,y=95)
        self.add3=Button(self.menu,text="ADD",width=5,height=1,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.sweadd)
        self.add3.place(x=650,y=145)
        self.add4=Button(self.menu,text="ADD",width=5,height=1,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.dadd)
        self.add4.place(x=650,y=195)
        self.add5=Button(self.menu,text="ADD",width=5,height=1,bd=6,bg="#a8ffff",
                         fg="#000000",command=self.roadd)
        ...
        #====================button==================
        self.menu=Button(self.button,text="MENU",width=13,height=4,bd=5,bg="#a8ffff",
                            fg="#000000",command=self.rate)
        self.menu.place(x=0,y=-2)
        self.cal=Button(self.button,text="CALCULATOR",width=13,height=4,bd=5,bg="#a8ffff",
                            fg="#000000",command=self.cal)
        self.cal.place(x=0,y=73)
        self.search=Button(self.button,text="RESET",width=13,height=4,bd=5,bg="#a8ffff",
                           fg="#000000",command=self.reset)
        ...
        self.L1=Label(self.bill,text="PROJECT BY:-AKANSHA GUPTA",
                      font=("cooper",17,"italic"),bg="#4F6367",fg="#EEF5DB")
        self.L1.place(x=10,y=140)
        #==================button=========
        self.button1=Button(self.bill,text="TOTAL",width=20,height=3,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.tot)
        ...
        self.button4=Button(self.bill,text="PRINT",width=20,height=3,bd=6,bg="#a8ffff",
                            fg="#000000",command=self.prt)
        ...
        self.ric.insert(END,str("\t     GUPTA'S GRILL"))
        self.ric.insert(END,str("\n\tGSTIN/UIN:05AAACS8577K1ZV "))
        self.ric.insert(END,str("\n\tState Name: UTTAR PRADESH Code:5"))
        self.ric.insert(END,str("\n\tE-Mail:akangup1999@gmail.com"))
        self.ric.insert(END,str("\n\t8923340545\t\tE&OE"))
        self.ric.insert(END,str("\n\tYour Satisfaction is Ours"))
        self.ric.place(x=5,y=5)
    ...
    def nvgadd(self):
        ...
        if str2=="":
            ...
            if str1=="PIZZA":
                ...
                num2=str(num2)
                self.ric.insert(END,str("\n        BURGER  "+val2+"       80          "+num2))
            elif str1=="FENCH FRIES":
                self.sb.delete('0',END)
                result=str2*120+str3
                self.sb.insert(END,int(result))
                num3=str2*120
                num3=str(num3)
                self.ric.insert(END,str("\n        FENCH FRIES  "+val2+"       120          "+num3))
            elif str1=="CHILLI POTATOI":
                self.sb.delete('0',END)
                result=str2*250+str3
                self.sb.insert(END,int(result))
                num4=str2*250
                num4=str(num4)
                self.ric.insert(END,str("\n        CHILLLI POTATO   "+val2+"       120          "+num4))
            elif str1=="MOMOS":
                self.sb.delete('0',END)
                result=str2*320+str3
                self.sb.insert(END,int(result))
...
class Menu:
    def __init__(self,root):
        ...
        self.top.place(x=0,y=0)
        #===================Main label=============
        self.l1=Label(self.top,text=" GUPTA'S GRILL (Menu)",font=self.font1,
                      bg="#EEF5DB",bd=8,fg="#FE5F55",justify=CENTER)
        self.l1.place(x=300,y=0)
        #=================VEG MENU=================
        ...
        self.lab1=Label(self.veg,text="VEG",font=self.font2,
                        width=15,bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        ...
        self.lab2=Label(self.ngveg,text="SNACKS",font=self.font2,
                        width=15,bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        self.lab2.place(x=190,y=10)
        self.dish=Label(self.ngveg,text="DISH\t\t\t RATE  DISH ",font=self.font5,bg="#4F6367",
                        fg="#EEF5DB",justify=RIGHT)
        self.dish.place(x=30,y=50)
        self.lb1=Label(self.ngveg,text="PIZZA\t\t\t 250 ",font=self.font4,bg="#4F6367",
                       fg="#EEF5DB",justify=RIGHT)
        self.lb1.place(x=30,y=80)
        self.lb2=Label(self.ngveg,text="BURGER(Cheesy)\t\t 80",font=self.font4,bg="#4F6367",
                       fg="#EEF5DB",justify=RIGHT)
        self.lb2.place(x=30,y=110)
        self.lb3=Label(self.ngveg,text="CHILI POTATO\t\t 120",font=self.font4,bg="#4F6367",
                       fg="#EEF5DB",justify=RIGHT)
        self.lb3.place(x=30,y=140)
        self.lb4=Label(self.ngveg,text="FENCH FRIES\t\t 120",font=self.font4,bg="#4F6367",
                       fg="#EEF5DB",justify=RIGHT)
        self.lb4.place(x=30,y=170)
        self.lb5=Label(self.ngveg,text="MOMOS(8 PIECES)\t\t 100",font=self.font4,bg="#4F6367",
                       fg="#EEF5DB",justify=RIGHT)
        self.lb5.place(x=30,y=200)
        #=================SWEETS===================
...
class Calc(Front):
     def __init__(self,root):
          #=========Frame==============
          self.f=Frame(root,width=350,height=400,bg="#a8ffff")
          self.f.propagate()
          self.f.pack()
          #=========LABEL==============
...
class About:
    def __init__(self,window):
        #================Main label=============
        self.top=Frame(window,width=1366,height=120,bd=5,bg="#fcfcb1",relief=RAISED)
        self.top.propagate(0)
        self.top.place(x=0,y=0)
        #===================Main label=============
        self.l1=Label(self.top,text="GUPTA'S GRILL",font=("cinzel",50,"bold"),
                      bg="#EEF5DB",bd=8,fg="#150675",justify=CENTER)
        self.l1.place(x=400,y=0)
        #================Top Frame=========
        self.right=Frame(window,width=1366,height=620,bd=5,bg="#000000",relief=RAISED)
        self.right.propagate(0)
        self.right.place(x=0,y=120)
        #===================Main label=============
        self.l1=Label(self.right,text="\t\t\t*****YOUR SATISFACTION IS OUR RESPONSIBILITY*****",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        self.l1.place(x=0,y=20)
        self.l1=Label(self.right,text="1.Restaurant Billing System is a type of software which is developed in Python use for providing the bill of the",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=80)
        self.l1=Label(self.right,text="regular customer.",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=120)
        self.l1=Label(self.right,text="2. In this software the bill is calculated (including GST) with the help of pre define rate. ",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=170)
        self.l1=Label(self.right,text="3. This software help the user to save time, save paper and less manpower required. ",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=220)
        self.l1=Label(self.right,text="4. In this project, the staff of the grill have a record of menu list, price, and this project helps them to make ",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=270)
        self.l1=Label(self.right,text="and print bills for the customer. ",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#EEF5DB",justify=CENTER)
        self.l1.place(x=10,y=310)
        self.l1=Label(self.right,text="\t\t\t*****PRODUCED BY : AKANSHA GUPTA*****",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        self.l1.place(x=10,y=380)
        self.l1=Label(self.right,text="\t\t\tCONTACT : akansha.gupta.cse.2017@miet.ac.in",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        self.l1.place(x=10,y=420)
        self.l1=Label(self.right,text="\t\t\tLinkedin : https://www.linkedin.com/in/akansha-gupta-30b4b2196",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
        self.l1.place(x=10,y=460)
        self.l1=Label(self.right,text="\t\t\tGithub : https://github.com/Akansha-procoder",font=("cinzel",18,"bold"),bg="#000000",bd=8,fg="#a8ffff",justify=CENTER)
